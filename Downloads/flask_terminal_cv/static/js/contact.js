...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const terminalSequence = [
        ...
        { delay: 50, text: '║  Email:     your@email.com                    ║', className: 'info-box' },
        { delay: 50, text: '║  GitHub:    github.com/YOUR_USERNAME          ║', className: 'info-box' },
        { delay: 50, text: '║  LinkedIn:  linkedin.com/in/YOUR_USERNAME     ║', className: 'info-box' },
        { delay: 50, text: '║  Location:  Germany 🇩🇪                        ║', className: 'info-box' },
        { delay: 50, text: '╚════════════════════════════════════════════════╝', className: 'info-box' },
